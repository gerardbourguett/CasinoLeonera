...
public class AlmuerzoCoelemu {
    String t_entrada, t_ensalada1, t_ensalada2, t_principal, t_alternativo, t_hipocalorico, t_postre1, t_postre2;

    public AlmuerzoCoelemu(TextView t_entrada, TextView t_ensalada1, TextView t_ensalada2,
                           TextView t_principal, TextView t_alternativo, TextView t_hipocalorico,
                           TextView t_postre1, TextView t_postre2) {
    }

    public AlmuerzoCoelemu(String t_entrada, String t_ensalada1, String t_ensalada2, String t_principal, String t_alternativo, String t_hipocalorico, String t_postre1, String t_postre2) {
